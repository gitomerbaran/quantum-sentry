...
use crate::model::{BBOTickRow, DepthSnapshotRow, LiquidationTickRow, MarketContextRow, TradeTickRow};
...
impl ClickHouseWriter {
    pub fn new_from_env() -> Self {
        ...
        let database = std::env::var("CLICKHOUSE_DB").unwrap_or_else(|_| "quantum".to_string());
